...
<head>
    ...
    <title>Webinar on the Preamble</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1>The Preamble: Foundation of the Indian Constitution</h1>
            <p>Join us for an insightful discussion on the significance of the Preamble in shaping the identity and values of India.</p>
            <p>Date: 10th October 2024 | Time: 4:00 PM IST</p>
            <p>Speaker: Neha Chowdary</p>
            <p>Duration: 1 hour</p>
