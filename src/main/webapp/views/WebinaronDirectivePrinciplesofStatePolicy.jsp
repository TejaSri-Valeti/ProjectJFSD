...
<head>
    ...
    <title>Webinar on Directive Principles of State Policy</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1>Directive Principles of State Policy: A Guiding Framework</h1>
            <p>Join us for a webinar that delves into the role of Directive Principles in shaping state policies and achieving social and economic justice.</p>
            <p>Date: 12th October 2024 | Time: 5:00 PM IST</p>
            <p>Speaker: Ananya Kumar</p>
            <p>Duration: 1 hour</p>
