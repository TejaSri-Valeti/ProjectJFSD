...
<head>
    ...
    <title>Webinar on Federal Structure of India</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1>Understanding the Federal Structure of India</h1>
            <p>Join us to explore the federal system in India and how power is distributed between the central and state governments.</p>
            <p>Date: 25th October 2024 | Time: 6:00 PM IST</p>
            <p>Speaker: Prof. Anil Sharma</p>
            <p>Duration: 1 hour</p>
    ...
    <script>
        function register() {
            // Display success message when the register button is clicked
