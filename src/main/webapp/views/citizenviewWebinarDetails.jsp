...
<%@ include file="citizendashboard.jsp" %>  <!-- Include Citizen Dashboard -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            <a href="citizenprofile">View Profile</a>
