...
<head>
    ...
    <style>
        ...
        .container {
            width: 90%;
            max-width: 550px; /* Limit width for a compact layout */
        ...
        table {
            width: 105%; /* Full width of container */
            margin-top: 20px;
        ...
        <tbody>
            <c:forEach var="citizen" items="${citizenList}">
                <tr>
                    ...
                    <td>
                        <a href="updatecitizensdetails?cid=${citizen.id}" class="update-button">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
