...
<head>
    ...
    <title>Directive Principles Discussion Forum</title>
    <style>
        body {
...
<body>
 <%@ include file="citizendashboard.jsp" %>
    <div class="container">
        <h1>Directive Principles Discussion Forum</h1>
        <p>Discuss the Directive Principles of State Policy (DPSP) outlined in the Indian Constitution. Explore their role in shaping government policies and social welfare.</p>
        ...
        <div class="discussion-list" id="discussionList">
            ...
            <div class="discussion-item">
                <strong>The Role of DPSP in Achieving Social Justice</strong>
                <p>How effective are the Directive Principles in promoting social and economic justice in India?</p>
            </div>
            <div class="discussion-item">
                <strong>Balancing Fundamental Rights and Directive Principles</strong>
                <p>How can the government balance the need to implement Directive Principles while upholding Fundamental Rights?</p>
            </div>
        </div>
